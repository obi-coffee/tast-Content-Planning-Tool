...
function StatCard({ label, value, sub, color = "#1a1a1a", accent }) {
  return (
    <div className="bg-white rounded-2xl border border-warm-border/60 p-4 flex flex-col gap-1">
        ...
        return (
          <div key={i} className="rounded-xl border px-4 py-3 flex items-start gap-3"
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-warm-text">{g.label}</p>
      ...
      {recommendations.map((r, i) => {
        ...
        return (
          <div key={i} className="rounded-xl border px-4 py-3 flex items-start gap-3" style={{ background: s.bg, borderColor: s.border }}>
            <div className="w-2 h-2 rounded-full mt-1.5 shrink-0" style={{ background: s.dot }} />
            <div>
              <p className="text-sm font-semibold text-warm-text">{r.message}</p>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          <h2 className="font-serif text-xl text-warm-text">Analytics</h2>
      ...
      <div className="bg-white rounded-2xl border border-warm-border/60 p-4 mb-5">
        <div className="flex items-start justify-between mb-3">
          <div>
            <p className="text-sm font-semibold text-warm-text">Content ratio</p>
      ...
      <div className="bg-white rounded-2xl border border-warm-border/60 p-4 mb-5">
        <div className="mb-3">
          <p className="text-sm font-semibold text-warm-text">Phase progress</p>
                ...
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-semibold text-warm-text">{p.name}</p>
                      {p.isActive && (
      ...
      <div className="grid md:grid-cols-2 gap-5 mb-5">
        {/* ── Cadence ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <div className="flex items-start justify-between mb-3">
            <div>
              <p className="text-sm font-semibold text-warm-text">Monthly cadence</p>
        ...
        {/* ── Gap detector ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-1">Pipeline health</p>
      ...
      <div className="grid md:grid-cols-2 gap-5 mb-5">
        {/* ── By channel ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-3">By channel</p>
          {byCh.map(ch => (
        ...
        {/* ── By theme ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-3">By theme</p>
          {byType.length === 0
      ...
      <div className="grid md:grid-cols-2 gap-5 mb-5">
        {/* ── Posting heatmap ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-1">Publishing heatmap</p>
        ...
        {/* ── Team workload ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-3">Team workload</p>
          {byMember.length === 0
      ...
      {campaignStats.length > 0 && (
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4 mb-5">
          <p className="text-sm font-semibold text-warm-text mb-3">Campaign health</p>
          <div className="space-y-3">
            {campaignStats.map(c => {
      ...
      <div className="grid md:grid-cols-2 gap-5 mb-5">
        {/* ── Performance Metrics ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-1">Performance tracking</p>
        ...
        {/* ── Smart Recommendations ── */}
        <div className="bg-white rounded-2xl border border-warm-border/60 p-4">
          <p className="text-sm font-semibold text-warm-text mb-1">Smart recommendations</p>
